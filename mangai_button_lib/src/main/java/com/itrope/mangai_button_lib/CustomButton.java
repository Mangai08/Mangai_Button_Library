package com.itrope.mangai_button_lib;
...
public class CustomButton extends AppCompatButton {
    ...
    public CustomButton(Context context, AttributeSet attrs) {
        ...
        backgroundColor = typedArray.getColor(R.styleable.CustomButton_background_color, context.getColor(R.color.colorBlack));
        ...
        textColor = typedArray.getColor(R.styleable.CustomButton_text_color, context.getColor(R.color.white));
        ...
        cornerRadius = typedArray.getDimension(R.styleable.CustomButton_corner_radius, 20);
